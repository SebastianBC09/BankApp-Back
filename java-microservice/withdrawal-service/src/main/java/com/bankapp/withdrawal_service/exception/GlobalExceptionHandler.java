package com.bankapp.withdrawal_service.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponseDTO<Object>> handleInsufficientFundsException(InsufficientFundsException ex) {
        System.err.println("Insufficient funds: " + ex.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(ApiResponseDTO.fail(null, ex.getMessage()));
    }
